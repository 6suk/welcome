			...
			<div class="inputtb content col-lg-8">
				...
				<form action="/board/write" class="pt-4 mx-3" method="post"
					...
					<table class="inputtb board-desc">
						...
						<tr>
							<td>
									<input type="checkbox" name="tag" value="0" class="form-check-input"><label class="form-check-label">호텔</label>
									<input type="checkbox" name="tag" value="1" class="form-check-input"><label class="form-check-label">유치원</label>
									<input type="checkbox" name="tag" value="2" class="form-check-input"><label class="form-check-label">실내</label>
									<input type="checkbox" name="tag" value="3" class="form-check-input"><label class="form-check-label">야외</label>
									<input type="checkbox" name="tag" value="4" class="form-check-input"><label class="form-check-label">미용</label>
							</td>
						</tr>
						<tr>
							<td><input style="border: 1px solid #d1d1d1;"
								class="board-input" type="text" placeholder="운영시간"
								name="closeTime" maxlength="128" /></td>
						</tr>
						<tr>
							<td><input style="border: 1px solid #d1d1d1;"
								class="board-input" type="text" placeholder="홈페이지"
								name="homepage" maxlength="128" /></td>
						</tr>
